...
# tuples, because they are a sequence, are 0-indexe
...
# If you only pass one argument to range, 
# it specifies the stop marker and start is 0 by default
zero_start: range = range(10)
for x in zero_start:
    print(x)


names: list[str] = ["Carsen", "Logan", "Jay", "Claire"]
